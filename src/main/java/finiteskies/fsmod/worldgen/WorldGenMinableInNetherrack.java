...
public class WorldGenMinableInNetherrack extends WorldGenerator
{
    ...
    public WorldGenMinableInNetherrack(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.NETHERRACK));
    }

    public WorldGenMinableInNetherrack(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
