package finiteskies.fsmod.DynamicLights.common;
...
public class DLTransformer implements IClassTransformer
{
     ...
     */
    private String goalInvokeDesc = "(Lawr;Lamw;Let;)I";
                    ...
                    && (!obf || m.desc.equals(targetMethodDesc)))
            {
                ...
                */
                ...
                if (found)
                {
                    ...
                    m.instructions.insertBefore(targetNode, new MethodInsnNode(Opcodes.INVOKESTATIC, "finiteskies/fsmod/DynamicLights/client/DynamicLights", "getLightValue", goalInvokeDesc, false));
                }
                break;
            }
        }
