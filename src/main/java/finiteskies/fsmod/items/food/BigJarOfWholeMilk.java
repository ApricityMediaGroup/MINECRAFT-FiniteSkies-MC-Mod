...
public class BigJarOfWholeMilk extends Item {
	public BigJarOfWholeMilk() {
		setUnlocalizedName(Reference.FiniteItems.BIGJAROFWHOLEMILK.getUnlocalizedName());
		setRegistryName(Reference.FiniteItems.BIGJAROFWHOLEMILK.getRegistryName());
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase entityLiving)
    {
        ...
        return stack.func_190926_b() ? new ItemStack(ModItems.bigGlassJar) : stack;
    }
